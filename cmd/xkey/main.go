...
func run() {
	...
	asym.AnnihilatePrivateKey(key.PrivateKey)
	if err != nil {
...
// returns true if program execution is complete
...
func ImportBrainWallet() {
	...
	fmt.Println("Please enter the password for wallet encryption")
	...
	if err != nil {
		fmt.Printf("Error encrypting the wallet: %s\n", err.Error())
		return
	}
